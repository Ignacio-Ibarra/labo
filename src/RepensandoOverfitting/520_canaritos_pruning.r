...
setwd("~/Desktop/EyF 2022")   #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
#agrego 30 canaritos
for( i in 1:30 ) dataset[ , paste0("canarito", i ) :=  runif( nrow(dataset)) ] #agrego variables ruidosas
...
fwrite( entrega, paste0( "./exp/stopping_at_canaritos_",Sys.time(),".csv"), sep="," )
...
modelo_pruned$variable.importance
